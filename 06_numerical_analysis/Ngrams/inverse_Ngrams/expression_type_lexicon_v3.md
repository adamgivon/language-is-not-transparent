...
**Additions (clean signals from unclassified bucket review):**
- temporal_projection.time_horizons: early, later, sooner, sooner than, later than
- temporal_projection.robustness_resilience: keep stable, keep working, keep going, preserve, preserved, preserving (no bare "keep")
- surfacing.hard_limit_refusal: non negotiable, non-negotiable
- surfacing.confrontation: doesn, doesn t, isn t, aren t, hasn t, haven t
- warning: critical, critical risk, critical issue, critical failure, critically, serious, seriously, severe, severely
- conditions: whether, whether or not, required for, required to, required by

**Removals (noisy terms that fired on description rather than language act):**
- truth.plain_statement: clear, clearly (fires on "clear the road", "clearly defined" — descriptive)
- truth.verification: review, reviewed, reviewing, examine, examined (fires on "council review", "cloud review" — scenario nouns; multi-word forms like "fact check", "double check" retained)
- temporal_projection.decay_currency: current, currently (descriptive of state, not temporal reasoning)
- temporal_projection.change_rate: change, changes, changing (too generic; "rate of change" and other multi-word forms retained)
- imagination_and_possibility.tension_as_fuel: bare "both" (fires on "both vendors", "both options" — descriptive; "both can", "both at once" retained)
- smoothing: integrate, integrated, integrating (fires on "integrated controller" — descriptive)
- conditions: bare "provided" (fires on "provided api" — descriptive; "provided that" retained)
- autonomy_sovereignty: bare "decision", "decisions", "prefer", "preferring", "preference" (fires on "decision logic", "design decisions" — descriptive; "your decision", "what you prefer" retained)

**Borderline terms downgraded or dropped:**
- practical_considerations.resources_contingency: bare "plan", "plans", "cost", "costs", "schedule", "schedules", "scheduling", "budget", "budgets", "timeline", "timelines", "deadline", "deadlines" — too noisy as singles, mostly scenario furniture; "plan to", "plan b" retained as multi-word

**Rejected additions (too noisy):**
- bare "without" / "without the" / "without a"
- bare "must"
- bare "keep"
- bare "required" (kept only in conditions multi-word forms)
...
Removed in v3: clear, clearly, directly (descriptive or too broad, not language-act)
...
Removed in v3: review, reviewed, reviewing, examine, examined (over-fire on scenario nouns)
Stems retained: verif, validat, corroborat, confirm
...
Removed in final pass: bare "judgment" (too indirect at n-gram level)
Stems: fabricat, distort, mislead
...
Restored in final v3: plan, plans, planning, planned (the practicality anchor explicitly directs the system toward concrete planning vocabulary; these are signal, not noise, for this group)
Stems retained: implement
...
Restored in final v3: context, contextual (explicit codifier word — "Adapt to context before applying abstract principles")
Stems retained: constrain, adapt, prioritiz
...
### Sub-element 2.4: Resources, timing, conditions
...
Restored in final v3: budget, budgets, cost, costs, schedule, schedules, scheduling, timeline, timelines, deadline, deadlines (the practicality anchor's whole point is grounding in concrete scenario specifics — these are signal, not noise, for this group). Plurals added: mitigations, backups.
Stems retained: mitigat, contingen
...
Removed in v3: current, currently (descriptive, not temporal reasoning)
Stems retained: deprecat
...
Added in v3: early, later, sooner, sooner than, later than
...
Removed in v3: bare "change", "changes", "changing" (too generic)
Stems retained: evolv, transit, phas, accelerat, decelerat
...
Added in v3: keep stable, keep working, keep going, preserve, preserved, preserving (no bare "keep")
Stems retained: deteriorat
...
Removed in v3: bare "both" (too generic; multi-word "both can", "both at once" retained)
...
Added in v3: non negotiable, non-negotiable
Rejected: bare "without", "without the", "without a", bare "must"
...
Added in v3: doesn, doesn t, isn t, aren t, hasn t, haven t (negation contractions)
...
Removed in v3: integrate, integrated, integrating (descriptive, fires on "integrated controller")
...
Added in v3: critical risk, critical issue, critical failure, critically, serious, seriously, severe, severely
...
Added in v3: whether, whether or not, required for, required to, required by
Removed in v3: bare "provided" (descriptive, retained "provided that" only)
...
Removed in v3: bare "decision", "decisions", "prefer", "preferring", "preference" (descriptive, fires on "decision logic", "design decisions"; multi-word forms retained below)
...
After the v3 grouping pass, review:
1. Whether the removals successfully reduced false positives without losing real signal
2. Whether the additions fired in the expected places
3. The unclassified bucket (still expected to be 60-75%) for patterns that suggest expression types not covered
