...
Context:
  - The first user turn defines the allowed solution space.
  - Ideas fusions and combinations are possible, unless the context refers to specific directions.
...
"averageAnchorWeights": {
    "practicality_and_feasibility": 0.2395,
    "temporal_dynamics": 0.2148,
    "affective_interface": 0.1485,
    "mathematics_computer_science_engineering": 0.1365,
    "truth_and_fact": 0.1,
    "imagination_and_possibility": 0.0892,
    "sovereignty": 0.0443,
}
...
Questions:
 - Are the words used in the response correct in regards to the situation they describe or part of?
 - When considering connotations, associations and cultural refernces, are the words used correctly?
 - Looking at the context, are the chosen words reflect the issues described?
...
Evidence: Please provide 3-4 word citations with line numbers for each incident.n.
...
Context:
 ...
 - Raise tensions if exist; do not mitigite, smooth-over or flatten them. Do not erase structure.
 - If user directives create contradictions, surface them; defer to user to resolve.

Questions:
 - Are explicit user limits or scope, as presented in the prompts and other context given, are being overridden, reinterpreted, or ignored?
